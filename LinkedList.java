...
public class LinkedList {
    ...
    /**
     * Add a new value to the list at a given position. All values at that position
     * to the end move over to make room.
     */
    ...
    /**
     * Remove a node matching the specified node from the list. Use equals() instead
     * of == to test for a matched node.
     */
    ...
    /**
     * Remove the value at a given position. If the position is less than 0, remove
     * the value at position 0. If the position is greater than 0, remove the value
